...
A:hover { background-color: cornflowerblue; color: #c5d1d3; text-decoration: none; }

.stackpreview { display: inline-block; margin: 3ex 1em; padding: 4px;
  clear: both; text-align: center; background-color: #d3dee0;
  vertical-align: top; }
  /* margin: 2ex 0.5em; padding: 0.4ex 0.5em; */
.stackpreview P { margin-top: 0em; }
.stackpreview P + P, .stackpreview DIV + P { margin-bottom: 0.5em; }
.image A IMG, .image A TABLE { border: #c5d1d3 solid 4px; position: relative; left: -4px; top: -4px; }
.image A:hover IMG, .image A:hover TABLE { border-color: #d3dee0; opacity: 0.5; }
...
//    private static func render_doctype() -> DOMTreeNode {
//        return DOMTreeNode(name: "!doctype html")
//    }
    
    /* Void elements only have a start tag; end tags must not be specified for
     * void elements. */
//    private static func render_meta(attribute : [String : String]) -> DOMTreeNode {
//        return DOMTreeNode(begin: "<meta \(attribute)>", end: "")
//    }
